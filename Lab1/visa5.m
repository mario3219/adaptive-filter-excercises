...
[W,W2]=freqz(w,1);    
figure(2)
%subplot(311), stem(x(p+q-1:length(x)),'r+'), axis([0 M -1.2 1.2]), title('saend signal')
%subplot(312), stem(y(p:length(y)),'b+'), axis([0 M -1.2 1.2]), title('mottagen signal')
