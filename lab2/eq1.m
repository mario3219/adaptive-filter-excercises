function eq1
    ...
    Controls = {
        ...
        {{'Settings', 'Delay'},             'edit',             10,                 [34 21 14 1.75]}, ...
        {[],                                'text',             'Equalizer order',  [ 2 23 30 1.50]}, ...
        {{'Settings', 'EqualizerOrder'},    'edit',             10,                 [34 23 14 1.75]}, ...
        {[],                                'text',             'Symbol interval',  [ 2 25 30 1.50]}, ...
        {{'Settings', 'SymbolInterval'},    'edit',             5,                  [34 25 14 1.75]}, ...
        {[],                                'text',             'Window',           [ 2 27 30 1.50]}, ...
        {{'Settings', 'Window'},            'edit',             30,                 [34 27 14 1.75]}, ...
        ... Channel settings.
        {{'Settings', 'MakeChannel'},       'pushbutton',       'Make channel',     [ 2  31 46 1.75]}, ...
        {[],                                'text',             'Stop band attenuation', [ 2 35 30 1.50]}, ...
        {{'Settings', 'StopAttenuation'},   'edit',             0.3                      [34 35 14 1.75]}, ...
        {[],                                'text',             'Edge frequency',   [ 2 37 30 1.50]}, ...
        {{'Settings', 'EdgeFrequency'},     'edit',             0.2,                [34 37 14 1.75]}, ...
        {[],                                'text',             'Channel order',    [ 2 39 30 1.50]}, ...
        {{'Settings', 'ChannelOrder'},      'edit',             10,                 [34 39 14 1.75]}, ...
    };
    ...
    function MakeChannelCallback(varargin)       
        ...
        if K<2 || K>20
            error('Channel order must be between 2 and 20.');
        end
        ...
        fax = linspace(0, 1, 11);
        cut = round(f*2*11);
        mag = horzcat(ones(1,cut), A*ones(1,11-cut));
        
        states.hc = fir2(K, fax, mag);
        states.fc = (0:256)'/512;
        ...
        states.plothandles.hc = stem(handles.Channel.ChannelImpulse,     0:K, states.hc, 'bo');
        ...
        axis(handles.Channel.EqualizerAmplitude, [0, 0.5, 0, 1.1/A]);
...
%             set(handles.MainWindow, 'WindowStyle', 'normal', 'CloseRequestFcn', 'closereq');
        ...
        function TimerStepCallback(varargin)
            ...
            states.x(1) = x0;
            states.y(1) = states.hc * states.x(1:channelorder) + xn;
